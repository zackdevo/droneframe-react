...
const OtherEquips = (props) => {
    ...
    const equipCard = equipData.map((equip, index) => {
        return (
            <Grid sx={{ justifyContent: "center", marginBottom: "10px" }} item container xs={12} md={6} key={index}>
                <Grid item xs={12} md={6} sx={{ backgroundImage: `url(${equip.url})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center" }}></Grid>
                <Grid item xs={12} md={6} sx={{ backgroundColor: "rgba(255,255,255, 0.8)", textAlign: "justify", padding: "10px" }}>
